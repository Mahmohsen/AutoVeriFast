#ifndef ATOMICS_BOOL_H
#define ATOMICS_BOOL_H
...
predicate_family atomic_load_bool_operation_pre(void *op)(bool *pp, int prophecy);
predicate_family atomic_load_bool_operation_post(void *op)();
